...
test('all 103 augments have original native SVG with a compact, safe vocabulary',()=>{
  ...
  assert.equal(unique.size,103,'Family members have meaningful visual differences');
