...
test('all 93 augments have original native SVG with a compact, safe vocabulary',()=>{
  ...
  assert.equal(unique.size,93,'Family members have meaningful visual differences');
