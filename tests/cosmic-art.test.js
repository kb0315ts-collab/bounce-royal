...
test('all 96 augments have original native SVG with a compact, safe vocabulary',()=>{
  ...
  assert.equal(unique.size,96,'Family members have meaningful visual differences');
