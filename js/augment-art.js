...
(function (root) {
  ...
  const rows = [
    ...
    ['repulse', 'gravity', 'push', 'repel', '같은 중력 공 + 밀어내는 화살표: 주기적으로 주변 적을 나에게서 멀리 보낸다.'],
    ...
    ['thornLeash', 'barbedChain', 'collision', 'line-damage', '가시 돋친 사슬 + 두 공 배지: 꼬마볼과 내 공을 잇는 줄에 닿으면 다친다.'],
