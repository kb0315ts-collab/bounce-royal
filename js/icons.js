...
(function initBounceRoyalIcons(global) {
  const paths = Object.freeze({
    ...
    // 솔로 로그라이크 — 챔피언 왕관을 노리는 고블린볼
    rogue: '<g stroke="#243747" stroke-width="4" stroke-linejoin="round"><path d="M18 33 5 22l12 20M50 33l13-11-12 20" fill="#8fcf5a"/><circle cx="34" cy="38" r="18" fill="#8fcf5a"/><path d="M22 16l4-10 8 7 8-7 4 10Z" fill="#ffd44c"/><circle cx="27" cy="36" r="4.5" fill="#fffbe8" stroke-width="2.5"/><circle cx="41" cy="36" r="4.5" fill="#fffbe8" stroke-width="2.5"/><path d="M27.5 37h.1M41.5 37h.1" stroke-width="5"/><path d="M27 47h14" stroke-width="3.5"/><path d="M29 47l1.5-4 1.5 4M36 47l1.5-4 1.5 4" fill="#fff6dc" stroke-width="2"/></g>',
