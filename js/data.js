...
const WEAPONS = {
  sword:  { name:'검', ico:'⚔️', type:'melee', dmg:20, reach:60, tip:13, rot:3.0, hitCd:0.20, moveMult:0.90,
    desc:'긴 사거리와 높은 피해. 대신 회전·이동속도가 느리다.', stat:{atk:.85,spd:.45,rng:.7,mob:.4},
    skillName:'일섬 회전', skillDesc:'별도 피해 없이 0.6초 동안 정확히 한 바퀴 회전한다.' },
  dagger: { name:'단검', ico:'🔪', type:'melee', dmg:15, reach:30, tip:9, rot:5.0, hitCd:0.20, moveMult:1.15,
    desc:'짧고 피해는 낮지만 회전·이동속도가 매우 빠르다.', stat:{atk:.45,spd:.95,rng:.3,mob:.95},
  ...
  bow:    { name:'활', ico:'🏹', type:'ranged', dmg:12, interval:1.0, projSpeed:390, rot:2.6, moveMult:1.0,
    desc:'적당한 속도로 화살을 계속 발사하는 안정적인 원거리 무기.', stat:{atk:.55,spd:.65,rng:.95,mob:.7},
    skillName:'차지 샷', skillDesc:'1초 충전 후 다시 눌러 적과 장애물을 관통하는 피해 30의 화살 발사.' },
  pistol: { name:'권총', ico:'🔫', type:'ranged', dmg:6, burst:5, shotGap:0.12, reload:3.0, projSpeed:500, rot:3.0, moveMult:1.0,
    desc:'빠른 탄환 5연사 후 3초 재장전. 화력과 공백이 명확하다.', stat:{atk:.6,spd:.9,rng:.85,mob:.7},
    skillName:'고정 사격', skillDesc:'3초간 회전을 고정하고 재장전 없이 연속 난사한다.' },
  staff:  { name:'지팡이', ico:'🪄', type:'ranged', dmg:25, interval:2.5, projSpeed:135, bounces:1, rot:2.5, moveMult:1.0,
    desc:'느리고 강한 마법 투사체. 벽에 한 번 반사된다.', stat:{atk:1,spd:.15,rng:.8,mob:.7},
...
const AUGMENTS = [
  ...
  { id:'rot15',     cat:'stat', stackable:true, name:'쾌속 회전', desc:'회전속도 +15%' },
  ...
  { id:'accelRot',  cat:'time', name:'가속 회전', desc:'전투 중 5초마다 회전속도 +10%' },
  ...
  { id:'rampage20', cat:'time', name:'폭주 시간', desc:'전투 20초 이후 공격력·이동속도·회전속도 +20%' },
  // ---- 초반 / 후반 조건 ----
  ...
  { id:'battleExp',  cat:'streak', name:'전투 경험', desc:'라운드마다 회전속도 +2%' },
  ...
  { id:'brute',    cat:'trade', name:'괴력', desc:'공격력 +25% / 회전속도 -25%' },
  ...
  { id:'rotMomentum',cat:'onhit', name:'회전 탄력', desc:'무기 적중마다 회전속도 +6% (최대 8스택)' },
  ...
  { id:'motionSickness',cat:'link', name:'멀미 치료', desc:'회전하지 않는다. 현재 회전속도 배율을 이동속도·공격속도·공격력 배율로 1:1 전환' },
  // ---- 무기 전용 ----
  ...
  { id:'desperateSpin',cat:'weapon', weapon:'sword', name:'필사의 회전', desc:'HP 30% 이하에서 회전속도 +50%' },
  ...
  { id:'m_freeze',cat:'weapon', weapon:'mine', name:'빙결 지뢰', desc:'상대가 밟으면 2초간 이동·회전·공격속도 대폭 감소' },
  // ---- 캐릭터 스킬 카피 ----
